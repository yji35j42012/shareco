        ...
        <section class="cooperate">
            <div class="container">
                <div class="cooperate_txt fz26pxto16" data-aos="fade-up" data-aos-easing="ease-in-sine">
                    欢迎你与 SHARECO 合作，请备妥「联系资讯、网站/粉专网页、实体店名与
                    地址」等资料，以 e-mail 方式联系我们，将有专人于 3 天内与您联系。
                </div>
                <a class="border_btn" href="{{ route('contact') }}" data-aos="fade-up" data-aos-easing="ease-in-sine">其他联系方式</a>
            </div>
        </section>
