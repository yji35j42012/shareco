...
var moveSpeed=0.02
var rangeSpeen=50
console.log('rangeSpeen', rangeSpeen);
...
var six_s=100, six_e=0, six_m=0, six_d=0.2, sixOut_op=1, sixIn_op=0
...
function forthMove(move) {
	...
	console.log('forthMove', range3);
	console.log('forthMove', home_y);
	if (t<40) {
